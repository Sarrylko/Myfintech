...
function WizardStep2({
  ...
  const expenseCategories = budgetableCategories.filter((c) => !c.is_income);
  const incomeCategories = budgetableCategories.filter((c) => c.is_income);
  const isEmpty = budgetableCategories.length === 0;
